{{--
    Invitación digital — Mis XV Años de Mariana
    Single-file, self-contained, no Tailwind dependency.
    All styling lives in the inline <style>; all logic in inline <script>.

    ⚠️ Demo de portafolio con datos FICTICIOS. La galería pública apunta a esta
    invitación para no exponer los datos reales del cliente.
    Si quieres usarla de verdad, reemplaza TODOS los datos de abajo + los padrinos
    en la sección "Familia y padrinos" (~línea 2335) + el $pageUrl al final.
--}}
            ...
            <div class="xv-sponsors-card">
                ...
                <div class="sponsors-list">
                    ...
                    <div class="sponsor-item sponsor-parents">
                        <span>Padres</span>
                        <h3>Lucía Mendoza Rivera</h3>
                        <small>&amp;</small>
                        <h3>Carlos Solís Ortega</h3>
                    </div>

                    <div class="sponsor-item">
                        <span>Padrinos</span>
                        <h3>Andrea Reyes Hernández</h3>
                        <small>&amp;</small>
                    ...
                    <div class="sponsor-item">
                        <span>Padrinos</span>
                        <h3>Patricia Ortega Luna</h3>
                        <small>&amp;</small>
                        <h3>Ricardo Solís Vidal</h3>
                    </div>
    ...
    >
        ...
        <div class="confirm-modal-content" role="document">
            ...
            <div id="confirmFormState" class="confirm-form-state">
                ...
                >
                    @csrf
                    <input type="hidden" name="ruta_invitacion" value="xv-mariana">
