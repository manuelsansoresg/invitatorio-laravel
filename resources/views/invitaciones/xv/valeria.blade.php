...
@php
    ...
    $dressCode       = $invitacion?->dress_code ?: $config('dress_code', 'principal', 'Dress code a tu estilo');
...
<head>
    ...
    <style>
        ...
        :root {
            --bg: {{ $colorPrimario }};
            --bg-soft: color-mix(in srgb, var(--bg) 12%, #ffffff);
            --card: color-mix(in srgb, var(--bg) 6%, #ffffff);
            --rose: {{ $colorPrimario }};
            --rose-soft: {{ $colorAcento }};
            --rose-dark: color-mix(in srgb, var(--rose) 86%, #000000);
            --text: #3f4648;
            --muted: #8b8f91;
            --border: color-mix(in srgb, var(--rose) 35%, transparent);
            --shadow-card: 0 24px 70px color-mix(in srgb, var(--rose) 14%, transparent);
            --shadow-cover: 0 30px 60px -30px color-mix(in srgb, var(--rose) 35%, transparent),
                            0 12px 28px -18px color-mix(in srgb, var(--rose) 25%, transparent);
            --shadow-btn:  0 10px 24px -10px color-mix(in srgb, var(--rose) 45%, transparent);
            --shadow-btn-hover: 0 14px 30px color-mix(in srgb, var(--rose) 28%, transparent);
            --radius-card: 32px;
            --radius-btn: 14px;
        }
        ...
        * { box-sizing: border-box; }
        ...
        body {
            ...
            color: var(--text);
            background:
                radial-gradient(circle at top left, var(--bg-soft) 0%, transparent 40%),
                radial-gradient(circle at bottom right, color-mix(in srgb, var(--rose-soft) 20%, transparent) 0%, transparent 45%),
        ...
        .hero-button {
            ...
            align-items: center;
            gap: 10px;
            background: linear-gradient(135deg, var(--rose), color-mix(in srgb, var(--rose) 90%, #000000));
            color: #fff;
            font-family: 'Montserrat', sans-serif;
            font-size: 12px;
            font-weight: 600;
        ...
        .hero-countdown-box.live::after {
            ...
            border-radius: 50%;
            background: var(--rose);
            box-shadow: 0 0 0 0 color-mix(in srgb, var(--rose) 55%, transparent);
            animation: livePulse 1.6s ease-out infinite;
        }
        @keyframes livePulse {
            0%   { box-shadow: 0 0 0 0   color-mix(in srgb, var(--rose) 55%, transparent); }
            70%  { box-shadow: 0 0 0 8px color-mix(in srgb, var(--rose) 0%, transparent); }
            100% { box-shadow: 0 0 0 0   color-mix(in srgb, var(--rose) 0%, transparent); }
        }
        ...
        .xv-message-card {
            ...
            box-shadow: 0 24px 70px color-mix(in srgb, var(--rose-dark) 13%, transparent);
            backdrop-filter: blur(12px);
            -webkit-backdrop-filter: blur(12px);
        }
        ...
        .gallery-btn {
            ...
            place-items: center;
            cursor: pointer;
            box-shadow: 0 12px 30px color-mix(in srgb, var(--rose-dark) 16%, transparent);
            transition: transform 0.25s ease, box-shadow 0.25s ease, background 0.25s ease;
            padding: 0;
        }
        .gallery-btn:hover {
            transform: translateY(-50%) scale(1.04);
            box-shadow: 0 16px 36px color-mix(in srgb, var(--rose-dark) 22%, transparent);
            background: #fff;
        }
        .gallery-btn-prev {
            left: -22px;
        ...
        .sponsor-item:hover {
            ...
            box-shadow: 0 18px 38px color-mix(in srgb, var(--rose-dark) 12%, transparent);
        }
        .sponsor-item > span {
            display: block;
            margin-bottom: 14px;
        ...
        .ubicacion-map {
            ...
            overflow: hidden;
            border: 1px solid var(--border);
            box-shadow: 0 12px 32px -16px color-mix(in srgb, var(--rose-dark) 20%, transparent);
            background: var(--bg-soft);
        }
        ...
        .dress-reserved-circle {
            ...
            inset: 0;
            border-radius: 50%;
            background: var(--rose-soft, #F7C9D6);
            border: 2px solid rgba(255, 255, 255, 0.85);
            box-shadow: 0 4px 10px -4px color-mix(in srgb, var(--rose-dark) 35%, transparent);
        }
        .dress-reserved-x {
            position: absolute;
            inset: -4px;
        ...
        .sobre-card {
            ...
            background: linear-gradient(180deg, var(--card) 0%, color-mix(in srgb, var(--bg) 8%, #ffffff) 100%);
            border: 1.5px solid var(--rose);
            border-radius: 14px;
            box-shadow:
                0 18px 40px -18px color-mix(in srgb, var(--rose-dark) 32%, transparent),
                inset 0 -6px 14px color-mix(in srgb, var(--rose) 6%, transparent);
            overflow: hidden;
        }
        ...
        .sobre-card::after {
            ...
            background:
                linear-gradient(123deg,
                    ...
                    color-mix(in srgb, var(--rose) 45%, transparent) calc(50% - 0.8px) calc(50% + 0.8px),
                    transparent calc(50% + 0.8px)),
        ...
        .sobre-heart {
            ...
            font-size: 38px;
            line-height: 1;
            text-shadow: 0 2px 6px color-mix(in srgb, var(--rose) 20%, transparent);
            z-index: 1;
        }
        ...
        .confirm-modal-content {
            ...
            overflow-y: auto;
            background: linear-gradient(180deg, var(--card) 0%, color-mix(in srgb, var(--bg) 12%, #ffffff) 100%);
            border: 1px solid var(--border);
            border-radius: 28px;
            box-shadow:
                0 30px 70px -20px color-mix(in srgb, var(--rose-dark) 35%, transparent),
                0 12px 28px -18px color-mix(in srgb, var(--rose) 25%, transparent);
        ...
        .confirm-input {
            ...
            border: 1.5px solid color-mix(in srgb, var(--rose) 32%, transparent);
            border-radius: 14px;
            outline: 0;
            text-align: center;
        ...
        .confirm-input:focus {
            border-color: var(--rose);
            background: #fff;
            box-shadow: 0 0 0 4px color-mix(in srgb, var(--rose) 12%, transparent);
        }
...
<body id="page-body" class="{{ $isEditorPreview ? 'invitation-opened' : '' }}">
    ...
    {{-- ============================================================
         CONTENIDO PRINCIPAL
         ============================================================ --}}
    <main id="invitation-content" class="{{ $isEditorPreview ? '' : 'hidden' }}">
        ...
        {{-- 2) MENSAJE EMOCIONAL (Valentina) --}}
        @if ($isActive('mensaje'))
        <section id="mensaje-valentina" class="xv-message-section reveal" aria-label="Mensaje de {{ $nombre }}">
        ...
        {{-- 3) GALERÍA / CARRUSEL --}}
        @if ($isActive('galeria') && count($galeriaImagenes) > 0)
        ...
        <section id="padrinos" class="xv-sponsors-section reveal" aria-label="Padrinos">
            <div class="xv-sponsors-card">
                ...
                <p class="sponsors-intro">
                    {{ $block('padrinos')?->contenido ?: 'Gracias por acompañarme y formar parte de este momento tan especial.' }}
                </p>

                <div class="sponsors-list">
                    @foreach ($padrinosGrupos as $grupo)
                        <div class="sponsor-item {{ data_get($grupo, 'destacado') ? 'sponsor-parents' : '' }}">
                            <span>{{ data_get($grupo, 'label', 'Padrinos') }}</span>
                            @foreach (data_get($grupo, 'nombres', []) as $loopNombre)
                                @if (! $loop->first)
                                    <small>&amp;</small>
                                @endif
                                <h3>{{ $loopNombre }}</h3>
        ...
        <section id="dress-code" class="invite-section reveal" aria-label="Dress code">
            <div class="section-card dress-card">
                ...
                <p class="dress-main">{{ $dressCode }}</p>
        ...
        <section id="confirmacion" class="invite-section reveal" aria-label="Confirmar asistencia">
            <div class="section-card confirm-card">
                ...
                <p class="confirm-text">
                    {{ $block('whatsapp')?->contenido ?: 'Nos encantará contar contigo en este día tan especial.' }}
                </p>
            ...
            const goToGallerySlide = (index) => {
                ...
                setTimeout(() => {
                    ...
                    if (galleryLightboxTrigger) {
                        ...
                        galleryLightboxTrigger.dataset.lightboxAlt = 'Galería de {{ $nombre }} - foto ' + (currentGalleryIndex + 1);
                    }
