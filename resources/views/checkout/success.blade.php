                        ...
                        <ol class="space-y-4">
                            ...
                            <li class="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-0.5 text-[13px] text-[#5F5A66]">La armamos con los datos que nos mandes y te mostramos un preview.</p>
                                </div>
                            </li>
                            <li class="flex gap-4">
                                ...
                                <div>
                                    <p class="font-semibold text-[#2B143F]">Recibes un enlace listo para WhatsApp</p>
                                    <p class="mt-0.5 text-[13px] text-[#5F5A66]">Una vez aprobada, te mandamos el link para compartir con tus invitados.</p>
                                </div>
                            </li>
                        </ol>
                    </div>
