@php
    ...
    $faqs = [
        ...
        ['q' => '¿Cómo se paga?', 'a' => 'Aceptamos pago con tarjeta de crédito/débito, transferencia, OXXO y Mercado Pago. Pagas el 100% al confirmar el paquete y en menos de 24 h te contactamos para empezar a armar tu invitación.'],
    ];
    $eventTypes = [
